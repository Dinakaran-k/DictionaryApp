package com.dinakaran.dictionaryapp.view
            ...
            Column(
                ...
                wordResult?.let { wordData ->
                   ...
                   RoundedCard {
                    ...
                    val synonymAvailable = !wordMeaning.synonyms.isNullOrEmpty()
                    val antonymAvailable = !wordMeaning.antonyms.isNullOrEmpty()

                    if(synonymAvailable || antonymAvailable){
                        RoundedCard {
                            if (synonymAvailable){
                                Text(
                                    text = "Synonym",
